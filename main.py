...
from core.football_data_capture_engine_v15_9 import run_data_capture_v15_9
...
async def run() -> None:
    ...
    if (
        ...
        try:
            capture_report = run_data_capture_v15_9(
                samples=(
                    football_dataset_v15.training_ready
                    if "football_dataset_v15" in locals()
                    else 0
            ...
            log.info(
                "Football Data Capture Engine v15.9 finished: "
                "quality=%s/100, status=%s, meta_ai_ready=%s",
