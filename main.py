...
def run_full_pipeline_v15_34_1():
    ...
    # v15.29 resolver currently accepts only the source CSV argument.
    # This keeps compatibility while the resolver interface is upgraded.
    ...
    resolver_report = {
        ...
        "postmatch_rows_prepared": len(postmatch_rows),
...
if __name__ == "__main__":
    print(run_full_pipeline_v15_34_1())
