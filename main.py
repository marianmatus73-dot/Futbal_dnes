...
from core.football_smart_match_resolver_v15_29 import (
    run_smart_match_resolver_v15_29
)


def run_full_closing_pipeline_v15_29():
    ...
    resolver_report, matches = run_smart_match_resolver_v15_29(
        [
...
if __name__ == "__main__":
    print(run_full_closing_pipeline_v15_29())
