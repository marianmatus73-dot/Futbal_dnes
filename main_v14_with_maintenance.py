    ...
    if (
        ...
        try:
            ...
            log.info(
                ...
                "settled=%s, open=%s, accuracy=%.3f, "
                "brier=%.4f, avg_clv=%.4f",
                football_maintenance.deleted_market_snapshots,
                football_maintenance.deleted_diagnostics_rows,
                football_maintenance.settled_samples,
                football_maintenance.open_samples,
                football_maintenance.accuracy,
                football_maintenance.brier_score,
                football_maintenance.average_clv,
            )
