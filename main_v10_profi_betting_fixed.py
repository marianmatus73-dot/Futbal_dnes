...
AI_FEATURES = [
    ...
    "odds_edge_ratio", "score", "is_home_pick", "is_draw_pick", "is_away_pick", "is_total_pick",
]
...
def build_ai_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    """
    out = df.copy()
    for col in ["edge", "market_edge", "kurz", "lh", "la", "prob_model", "prob_market", "prob_final", "score"]:
