...
def run_full_pipeline_v15_48():
    ...
    _, opening_rows = run_opening_odds_bridge_v15_43(
        resolved
    )

    closing_report, merged_rows = run_closing_features_bridge_v15_48(
        opening_rows
    )
...
if __name__ == "__main__":
    print(run_full_pipeline_v15_48())
