...
from core.football_closing_odds_bridge_v15_45 import run_closing_odds_bridge_v15_45
from core.football_opening_closing_clv_engine_v15_44 import run_clv_engine_v15_44


def run_full_pipeline_v15_45():
    ...
    closing_report, merged_rows = run_closing_odds_bridge_v15_45(
        opening_rows,
        resolved,
    )

    clv_report, _ = run_clv_engine_v15_44(
        merged_rows
    )
...
if __name__ == "__main__":
    print(run_full_pipeline_v15_45())
