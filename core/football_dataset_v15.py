        ...
        with self.connect() as conn:
            conn.execute(
                ...
                CREATE TABLE IF NOT EXISTS football_dataset_v15 (
                    ...
                    competition_importance REAL,
                    is_international REAL,
                    is_knockout REAL,
                    is_qualification REAL,
                    season_stage REAL,
                    context_reliability REAL,
                    raw_edge REAL,
