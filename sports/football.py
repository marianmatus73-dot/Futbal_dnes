...
class FootballModule(SportModule):
    ...
    def _football_home_adjustment(self, home: str, away: str, selection: str) -> float:
        if os.getenv("FOOTBALL_HOME_ADV_ENABLED", "1") != "1":
            return 0.0

        home_adv = float(os.getenv("FOOTBALL_HOME_PROB_ADV", "0.020"))
    ...
    async def scan(self, settings: Settings) -> SportResult:
        ...
        return SportResult(
            ...
            bets=bets[:top_n],
            message=(
                "Football v12: standalone meta-model/fallback/CLV/ELO/Monte Carlo model. "
                f"Settled: {settled}. "
