...
def basketball_selection_score(probability: float) -> float:
...
class BasketballModule(SportModule):
    name = "basketball"
    ...
    def _basketball_home_adjustment(self, home: str, away: str, selection: str) -> float:
        if os.getenv("BASKETBALL_HOME_ADV_ENABLED", "1") != "1":
            return 0.0

        home_adv = float(os.getenv("BASKETBALL_HOME_PROB_ADV", "0.012"))
    ...
    async def scan(self, settings: Settings) -> SportResult:
        ...
        grade_min_samples = int(os.getenv("BASKETBALL_BOOKMAKER_GRADE_MIN_SAMPLES", "20"))
        ...
        for sport_key in clean_sport_keys:
            ...
            for event in data:
                ...
                for bookmaker, selection, odds in best_outlier_prices(bookmakers):
                    ...
                    home_adj = self._basketball_home_adjustment(
                        home=home,
                        away=away,
                        selection=selection,
                    )
                    ...
                    probability_reason = "original basketball probability"
                    ...
                    bet = Bet(
                        ...
                        bookmaker=bookmaker,
                        start_time=start,
                        score=basketball_selection_score(prob_final),
                    ...
                    self._audit(
                        ...
                        edge,
                        "PASS",
                        f"bookmaker grade {grade:.2f}, elo_adj {elo_adj:.3f}, home_adj {home_adj:.3f}, probability_source={probability_source}, probability_reason={probability_reason}",
                    )
        ...
        return SportResult(
            ...
            bets=bets[:top_n],
            message=(
                "Basketball v12: meta-model/fallback/CLV/ELO market model. "
                f"Settled: {settled}. "
