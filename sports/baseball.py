...
class BaseballModule(SportModule):
    ...
    async def scan(self, settings: Settings) -> SportResult:
        ...
        for sport_key in clean_sport_keys:
            ...
            for event in data:
                ...
                for bookmaker, selection, odds in best_outlier_prices(
                    ...
                    preview_edge = fallback_probability * odds - 1.0
                    preview_confidence = confidence_score(
                        ConfidenceInput(
                            edge=preview_edge,
                            consensus=max(0.0, min(0.20, preview_edge)),
                            bayesian=0.50,
                            clv=0.0,
                    ...
                    probability_reason = "original baseball probability"
                    ...
                    try:
                        ...
                        prob_final = clamp(predict_probability(features))
                    ...
                    audit_context = (
                        ...
                        f"fallback_probability={fallback_probability:.4f}; "
        ...
        return SportResult(
            ...
            bets=bets[:top_n],
            message=(
                "Baseball v12: meta-model/fallback/CLV/ELO/Bayesian/"
                "adaptive confidence/Monte Carlo model. "
                f"Settled: {settled}. "
